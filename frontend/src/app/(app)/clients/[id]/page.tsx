...
export default function ClientDetailPage({ params }: { params: { id: string } }) {
  ...
  const hasReportForNCStage = useCallback((stageType: string) => {
    return auditReports.some((report) => report.stage_type === stageType)
  }, [auditReports])
        ...
        <div className="flex items-start gap-4 rounded-xl border border-emerald-300 bg-emerald-50 p-5">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-emerald-800">
              The certificate has been issued, the workflow is now{' '}
              <strong>Certified</strong>, and the certification cycle is available to CRM.
            </p>
